...
@section('content')
    <div class="container mt-4 bg-white py-3" id="tags">
            ...
            <form action="{{ route('tags.store') }}" method="post">
                <div class="row justify-content-between">
                    ...
                    <div class="col-4 position-relative">
                        ...
                        <div class="position-absolute" style="top:7px;left: 70px;"><span class="iconfont f36" :class="selected"></span></div>
                            <!-- Modal -->
        ...
        <div class="row mb-1">
            ...
            <div class="col-4 mt-2"><span class="iconfont f36 {{ $tag->icon }}"></span></div>
            <div class="col-4">
